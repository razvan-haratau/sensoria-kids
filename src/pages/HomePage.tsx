  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-[#5BC4C0]/10 to-[#E86B9E]/10">
        ...
        {/* MOBILE */}
        <div className="lg:hidden flex flex-col items-center text-center px-4 sm:px-6 pt-24 pb-0 w-full">
        ...
        {/* DESKTOP */}
        <div className="hidden lg:grid max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid-cols-2 gap-12 items-center">
          <div>
